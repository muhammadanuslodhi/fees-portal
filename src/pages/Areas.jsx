            ...
            {areas.map(a => (
              <div key={a.id} className="card p-4 space-y-3">
                ...
                <div className="flex gap-2 pt-1 border-t border-surface-100">
                  ...
                  <button title="Edit Area" className="btn-secondary text-xs flex-1 text-primary-600 !py-2 justify-center" onClick={() => openEdit(a)}>
                    <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                  </button>
                  <button title="Delete Area" className="btn-secondary text-xs flex-1 text-red-500 !py-2 justify-center" onClick={() => remove(a.id)}>
                  ...
                  <tr key={a.id} className="table-row group">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                        ...
                        <button title="Edit Area" className="btn-secondary !p-2 text-primary-600" onClick={() => openEdit(a)}>
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                        </button>
                        <button title="Delete Area" className="btn-secondary !p-2 text-red-500" onClick={() => remove(a.id)}>
                          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                        </button>
                      </div>
                    </td>
