  ...
  return (
    <div className="space-y-6 animate-slide-up relative z-10">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-4xl font-extrabold text-white tracking-tight drop-shadow-md">Areas Management</h1>
          <p className="text-slate-400 mt-1">Manage society areas, chairmen, and view related fees.</p>
        </div>
                  ...
                  <tr key={a.id} className="table-row-hover group transition-all duration-200">
                    ...
                    <td className="px-6 py-5">
                      <div className="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        ...
                        <button className="btn-secondary !py-2 !px-4 text-xs font-bold shadow-md text-brand-400 border-brand-500/30 hover:bg-brand-500/10" onClick={() => openEdit(a)}>
                          Edit
                        </button>
                        <button className="btn-secondary !py-2 !px-4 text-xs font-bold shadow-md text-rose-400 border-rose-500/30 hover:bg-rose-500/10" onClick={() => remove(a.id)}>
                          Delete
                        </button>
                      </div>
                    </td>
        ...
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-md grid place-items-center z-50 p-4 animate-fade-in">
          <div className="card w-full max-w-md animate-slide-up shadow-[0_0_50px_rgba(0,0,0,0.5)] border-slate-600 bg-slate-800">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-2xl font-extrabold text-white">{editing ? 'Edit Area' : 'Add New Area'}</h2>
              ...
              <div>
                ...
                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-600 border-dashed rounded-xl hover:border-brand-500 transition-colors cursor-pointer bg-slate-900/50 group" onClick={() => document.getElementById('file-upload').click()}>
                  <div className="space-y-2 text-center">
                    <svg className="mx-auto h-12 w-12 text-slate-500 group-hover:text-brand-400 transition-colors" stroke="currentColor" fill="none" viewBox="0 0 48 48" aria-hidden="true">
