        ...
        {filtered.map((r, i) => (
          <div key={r.member.id} className="card p-4 space-y-3">
            ...
            <div className="flex gap-2 pt-2 border-t border-surface-100">
              <button title="Update Fee" className="btn-secondary flex-1 !py-2 text-primary-600 justify-center" onClick={()=>openUpdate(r)}>
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
              </button>
              <button title="Delete Member" className="btn-secondary flex-1 !py-2 text-red-500 justify-center" onClick={()=>deleteMember(r.member.id)}>
              ...
              {filtered.map((r, i) => (
                <tr key={r.member.id} className="table-row group">
                  ...
                  <td className="px-4 py-3 text-right opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
                    <button title="Update Fee" className="btn-secondary !p-2 text-primary-600" onClick={()=>openUpdate(r)}>
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" /></svg>
                    </button>
                    <button title="Delete Member" className="btn-secondary !p-2 text-red-500" onClick={()=>deleteMember(r.member.id)}>
                      <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" /></svg>
                    </button>
                  </td>
                </tr>
